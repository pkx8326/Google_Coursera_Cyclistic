...
![](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\R Markdown report\Cyclistic.jpg)
...
![*__Figure 2.1: The list of unzipped files seen in a folder on a Windows 10 machine__*](C:/Users/Acer/Desktop/Coursera Google Data Analytics/8_Google Data Analytics Capstone Complete a Case Study/Cyclistic data new/R Markdown report/unzipped files in folder.jpg)
...
![*__Figture 2.2: Files that are relatively small compared to the rest__*](C:/Users/Acer/Desktop/Coursera Google Data Analytics/8_Google Data Analytics Capstone Complete a Case Study/Cyclistic data new/R Markdown report/unzipped files in folder_smaller.jpg)
...
![*__Figure 3.2.1.1: A temporary table summarizing the exploratory results of the data sets in an Excel table__*](C:/Users/Acer/Desktop/Coursera Google Data Analytics/8_Google Data Analytics Capstone Complete a Case Study/Cyclistic data new/R Markdown report/excel summary_1.jpg)
...
![*__Figure 3.2.3.1: A temporary table summarizing the exploratory results of the data sets in an Excel table, including column indices of each data frame containing NAs__*](C:/Users/Acer/Desktop/Coursera Google Data Analytics/8_Google Data Analytics Capstone Complete a Case Study/Cyclistic data new/R Markdown report/excel summary_2.jpg)
...
![*__Figure 3.2.5.1: The total number of rows in the temporary excel table matches that calculated with the glimpse() function applied to the "alldata" data frame__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\R Markdown report\excel summary_3.jpg)
...
![*__Figure 4.1.1: A quick visualization that shows number of monthly rides from October 2020 to September 2021. Notice how the number increases and decreases in different times of year.__*](C:/Users/Acer/Desktop/Coursera Google Data Analytics/8_Google Data Analytics Capstone Complete a Case Study/Cyclistic data new/R Markdown report/number of monthly rides.jpg)
...
![*__Figure 4.2.1.1: A pie chart showing numbers of rides and their percentage values from each customer type__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\number of rides_pie chart.jpeg)
...
![*__Figure 4.2.2.1: The first box plot that doesn't give any statistical view. There are simply too many outliers.__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\trip duration boxplot_1.jpeg)
...
![*__Figure 4.2.2.2: A new box plot with statistics of ride duration from both customer groups__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\trip duration boxplot_2.jpeg)
...
![*__Figure 4.2.3.1: Number of Rides of Different Bike Types from both Customer Groups__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\grouped bar chart_bike type.jpeg)
...
![*__Figure 4.2.4.1: Starting locations in Chicago, IL for both customer groups__* ](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\starting location.jpeg)


![*__Figure 4.2.4.2: Ending locations in Chicago, IL for both customer groups__* ](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\ending location.jpeg)
...
![*__Figure 4.2.5.1: Grouped bar plot showing the total annual number of rides according to different days of the week__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\grouped bar chart_weekdays.jpeg)
...
![*__Figure 4.2.5.2: A grouped bar chart visualizing total annual number of rides at each hour of day__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\grouped bar chart_hourly rides.jpeg)
...
![*__Figure 4.2.6.1: A pie chart summarizing number of unidentified starting or ending stations for each customer group__*](C:\Users\Acer\Desktop\Coursera Google Data Analytics\8_Google Data Analytics Capstone Complete a Case Study\Cyclistic data new\Copy\analysis\unidentified starting or ending stations_pie chart.jpeg)
